<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="timkiem.ascx.cs" Inherits="FlowerShop.uc.timkiem" %>
<div id="wp-centercol_inner">
                     												<div id="wp-pos-breadcrumbs">
							<span class="breadcrumbs pathway clearafter">
								<a href="Default.aspx" class="home"></a>
							<div id="crumbs">  
                                <span class="current">Kết Quả Tìm Kiếm Cho Từ Khóa:  "<%=this.key %>"
                                </span></div>							</span>
...
<div class="product-listing-container">
	<h3 class="wp-moduletitle">
		<span>Kết Quả Tìm Kiếm :Có <%=this.count %> kết quả</span></h3>
</div>
<div>
	</div>
